<%@ Page Title="" Language="C#" MasterPageFile="~/admin_master_g8.Master" AutoEventWireup="true" CodeBehind="CRUDSecciones_g8.aspx.cs" Inherits="Aplicacion.CRUDSecciones_g8" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        ...
        <asp:SqlDataSource ID="Grados" runat="server" ConnectionString="<%$ ConnectionStrings:slplannerConnectionString %>" SelectCommand="SELECT DISTINCT [grado] FROM [grado]"></asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:slplannerConnectionString %>" SelectCommand="SELECT DISTINCT * FROM [grado]"></asp:SqlDataSource>
    </p>
    <p>
        ...
        <asp:SqlDataSource ID="Ciclos" runat="server" ConnectionString="<%$ ConnectionStrings:slplannerConnectionString %>" SelectCommand="SELECT DISTINCT [ciclo] FROM [ciclo]"></asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:slplannerConnectionString %>" SelectCommand="SELECT DISTINCT [ciclo], [nombre], [fecha_inicio], [fecha_fin] FROM [ciclo]"></asp:SqlDataSource>
    </p>
    <p>

<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasMaster/ma_coordinador_g8.Master" AutoEventWireup="true" CodeBehind="Entrada_Asistencia_g8.aspx.cs" Inherits="Aplicacion.Entrada_Asistencia_g8" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" >
    <h1>
        Asistencia-Entrada</h1>
